...
public class ResetPassword extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String err = "";
		if (username.equals("")) {
			err += "Enter your user information!";
		} else {
			if (userDAO.checkUser(username) == false) {
				err += "Duplicate usename!";
			}
		}
		...
		try {
			if (err.length() == 0) {
				...
				User new_user = new User(u.getUser_id(), username, "passwordreset", u.getBirthday(), u.getSex(), u.getEmail(), u.getPhoneNumber(), u.getAddress(), u.getRole());
